...
if($_POST)
{
	...
	function themezaa_email($subscribe_email,$user_name,$last_name=NULL,$phone_num=NULL,$comment=NULL,$purchase_email,$tz_from_email,$email_subject,$msg_php_email_sent,$msg_php_email_not_sent)
	{
		...
		$message = "<html>
					...
					<tr>
					<td colspan='2' align='center' valign='top'><img style=' margin-top: 15px; ' src='https://premiserv.co.uk/wp-content/uploads/2021/11/premiserv-registered-2-300x54-1.png' ></td>
					</tr>
					<tr>
